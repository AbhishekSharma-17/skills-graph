#!/usr/bin/env python3
"""
Astro Skill Update Checker
==========================
Checks for new upstream Astro versions and validates skill integrity.
...
UPSTREAM_VERSION_URL = "https://registry.npmjs.org/astro/latest"
DOCS_SITEMAP_URL = "https://docs.astro.build/sitemap-0.xml"
...
def fetch_upstream_version():
    """Fetch the latest Astro version from npm."""
    try:
        req = Request(
...
def check_version():
    ...
    if tracked == latest:
        ...
        print("\n  Action needed:")
        print("    1. Check https://github.com/withastro/astro/releases for breaking changes")
...
def check_sitemap():
    ...
    tracked_urls = {f"https://docs.astro.build{p}" for p in tracked_pages if p}
...
def generate_report():
    ...
    print(f"\n{'#' * 60}")
    print("  ASTRO SKILL UPDATE REPORT")
