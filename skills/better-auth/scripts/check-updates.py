#!/usr/bin/env python3
"""
Skill Update Checker — better-auth
====================================
...
# better-auth uses npm for version tracking
UPSTREAM_VERSION_URL = "https://registry.npmjs.org/better-auth/latest"
...
def generate_report():
    ...
    print(f"\n{'#' * 60}")
    print("  SKILL UPDATE REPORT — better-auth")
