...
Test the interface through the eyes of 5 distinct user archetypes. Each persona exposes different failure modes that a single perspective would miss.

## Instructions

1. Select 2-3 personas most relevant to the interface being evaluated (see Selection Guide below)
2. Walk through the primary user action as each persona
3. Report specific red flags -- not generic concerns. Name exact elements and interactions that fail.

---

## Persona 1: Impatient Power User -- "Alex"
...
## Persona 2: Confused First-Timer -- "Jordan"
...
## Persona 3: Accessibility-Dependent User -- "Sam"
...
## Persona 4: Deliberate Stress Tester -- "Riley"
...
- Do error states recover gracefully or leave the UI broken?
...
- Error handling that exposes technical details or leaves UI broken
...
## Persona 5: Distracted Mobile User -- "Casey"
...
## Selection Guide by Interface Type
...
When project design context is available (audience, brand, domain), derive 1-2 additional personas from that information:
...
**Profile**: [2-3 key characteristics derived from project context]
...
Only generate project-specific personas when real design context data is available. Do not invent audience details -- use the 5 predefined personas when no context exists.
