#!/usr/bin/env python3
"""
dlt Skill Update Checker
=========================
Checks for upstream dlt (PyPI) updates and validates skill integrity.
...
def check_version():
    ...
    try:
        ...
        with urlopen(req, timeout=10) as resp:
            ...
            print(f"\n  Check https://github.com/dlt-hub/dlt/releases for changes")
            return True
...
def full_report():
    ...
    print(f"\n{'#'*60}")
    print(f"  DLT SKILL — UPDATE & INTEGRITY REPORT")
