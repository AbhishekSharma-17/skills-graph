#!/usr/bin/env python3
"""
Drizzle ORM Skill Update Checker
==================================
Checks for upstream Drizzle ORM updates and validates skill integrity.
...
NPM_REGISTRY_URL = "https://registry.npmjs.org/drizzle-orm/latest"
...
def check_version():
    ...
    print(f"  Tracked ORM:       {ver['source_version_tracked']}")
    ...
    try:
        ...
        with urlopen(req, timeout=10) as resp:
            ...
            if latest == tracked:
                ...
                print(f"  Check https://orm.drizzle.team/docs/latest-releases for changes")
            return True
...
def generate_report():
    print(f"\n{'#'*60}")
    print(f"  DRIZZLE ORM SKILL — UPDATE REPORT")
