#!/usr/bin/env python3
"""
Fastify Skill Update Checker
================================
Checks for upstream Fastify (npm) updates and validates skill integrity.
...
def check_version():
    ...
    try:
        ...
        with urlopen(req, timeout=10) as resp:
            ...
            print(f"\n  Check https://github.com/fastify/fastify/releases for changes")
            return True
...
def generate_report():
    print(f"\n{'#'*60}")
    print(f"  FASTIFY SKILL — UPDATE REPORT")
