#!/usr/bin/env python3
"""
Grafana Skill Update Checker
=================================
Checks for upstream Grafana (Docker Hub) updates and validates skill integrity.
...
DOCKER_IMAGE = "grafana/grafana-oss"
DOCKER_TAGS_URL = f"https://hub.docker.com/v2/repositories/{DOCKER_IMAGE}/tags?page_size=10&ordering=last_updated"
...
def check_version():
    ...
    try:
        ...
        with urlopen(req, timeout=10) as resp:
            ...
            print(f"\n  Check https://grafana.com/docs/grafana/latest/whatsnew/ for changes")
            return True
...
def generate_report():
    print(f"\n{'#'*60}")
    print(f"  GRAFANA SKILL — UPDATE REPORT")
