#!/usr/bin/env python3
"""
Instructor Skill Update Checker
================================
Checks for upstream Instructor (PyPI) updates and validates skill integrity.
...
def check_version():
    ...
    try:
        ...
        with urlopen(req, timeout=10) as resp:
            ...
            print(f"\n  Check https://github.com/567-labs/instructor/releases for changes")
            return True
...
def full_report():
    ...
    print(f"\n{'#'*60}")
    print(f"  INSTRUCTOR SKILL — UPDATE & INTEGRITY REPORT")
