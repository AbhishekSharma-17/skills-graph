...
# Langfuse uses PyPI for Python SDK version tracking
UPSTREAM_VERSION_URL = "https://pypi.org/pypi/langfuse/json"
...
def generate_report():
    ...
    print(f"\n{'#' * 60}")
    print("  SKILL UPDATE REPORT — langfuse")
