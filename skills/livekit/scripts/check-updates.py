#!/usr/bin/env python3
"""
LiveKit Skill Update Checker
==============================
Checks for upstream livekit-agents updates and validates skill integrity.
...
def check_version():
    """Compare tracked SDK version against PyPI latest."""
    ver = load_version()
    print(f"\n{'='*60}")
    ...
    try:
        ...
        with urlopen(req, timeout=10) as resp:
            ...
            if latest == tracked:
                ...
                print(f"  Check https://github.com/livekit/agents/releases for changes")
            return True
...
def generate_report():
    print(f"\n{'#'*60}")
    print(f"  LIVEKIT SKILL — UPDATE REPORT")
