...
# pymilvus uses PyPI for version tracking
UPSTREAM_VERSION_URL = "https://pypi.org/pypi/pymilvus/json"
...
def generate_report():
    ...
    print(f"\n{'#' * 60}")
    print("  SKILL UPDATE REPORT — milvus")
