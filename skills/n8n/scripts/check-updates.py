#!/usr/bin/env python3
"""
n8n Skill Update Checker
============================
Checks for upstream n8n (npm) updates and validates skill integrity.
...
def check_version():
    ...
    try:
        ...
        with urlopen(req, timeout=10) as resp:
            ...
            print(f"\n  Check https://docs.n8n.io/changelog for changes")
            return True
...
def full_report():
    ...
    print(f"\n{'#'*60}")
    print(f"  N8N SKILL — UPDATE & INTEGRITY REPORT")
