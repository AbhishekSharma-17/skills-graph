#!/usr/bin/env python3
"""
Pulumi Skill — Update Checker
==============================
Checks for new upstream Pulumi versions and validates skill integrity.
...
UPSTREAM_VERSION_URL = "https://api.github.com/repos/pulumi/pulumi/releases/latest"
DOCS_BASE_URL = "https://www.pulumi.com"
...
def check_version():
    ...
    if tracked == latest:
        ...
        print("\n  Action needed:")
        print("    1. Review CHANGELOG: https://github.com/pulumi/pulumi/blob/master/CHANGELOG.md")
...
def generate_report():
    print(f"\n{'#' * 60}")
    print("  PULUMI SKILL — UPDATE REPORT")
