...
UPSTREAM_VERSION_URL = "https://registry.npmjs.org/resend/latest"
...
def fetch_upstream_version():
    ...
    if UPSTREAM_VERSION_URL is None:
        return {"error": "UPSTREAM_VERSION_URL not configured."}
...
def generate_report():
    ...
    print(f"\n{'#' * 60}")
    print("  SKILL UPDATE REPORT — Resend")
