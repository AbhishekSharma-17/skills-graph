#!/usr/bin/env python3
"""
Strapi Skill Update Checker
================================
Checks for upstream Strapi (npm) updates and validates skill integrity.
...
def check_version():
    ...
    try:
        ...
        with urlopen(req, timeout=10) as resp:
            ...
            print(f"\n  Check https://github.com/strapi/strapi/releases for changes")
            return True
...
def full_report():
    ...
    print(f"\n{'#'*60}")
    print(f"  STRAPI SKILL — UPDATE & INTEGRITY REPORT")
