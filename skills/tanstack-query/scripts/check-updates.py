#!/usr/bin/env python3
"""
Skill Update Checker — tanstack-query
====================================
...
# @tanstack/react-query uses npm for version tracking
UPSTREAM_VERSION_URL = "https://registry.npmjs.org/@tanstack/react-query/latest"
...
def generate_report():
    ...
    print(f"\n{'#' * 60}")
    print("  SKILL UPDATE REPORT — tanstack-query")
