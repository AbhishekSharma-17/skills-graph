#!/usr/bin/env python3
"""
tRPC Skill Update Checker
==========================
Checks for upstream tRPC updates and validates skill integrity.
...
NPM_REGISTRY_URL = "https://registry.npmjs.org/@trpc%2Fserver/latest"
...
def check_version():
    ...
    print(f"  Tracked tRPC:      {ver['source_version_tracked']}")
    ...
    try:
        ...
        with urlopen(req, timeout=10) as resp:
            ...
            if latest == tracked:
                ...
                print(f"  Check https://github.com/trpc/trpc/releases for changes")
            return True
...
def generate_report():
    print(f"\n{'#'*60}")
    print(f"  TRPC SKILL — UPDATE REPORT")
