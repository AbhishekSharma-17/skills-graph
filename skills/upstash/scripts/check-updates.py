...
UPSTREAM_VERSION_URL = "https://registry.npmjs.org/@upstash/redis/latest"
...
def check_version():
    ...
    if tracked == latest or tracked.endswith(latest):
        print("\n  UP TO DATE")
        return True
    else:
...
def generate_report():
    ...
    print(f"\n{'#' * 60}")
    print("  SKILL UPDATE REPORT — Upstash")
